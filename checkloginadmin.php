	...
	else
	{

			{
				...
				if(isset($_POST["personal_username"]))
				{
					...
					$strSQL = "SELECT personal_id,personal_name,personal_username,personal_lastname,personal_status,major_id FROM personal WHERE personal_username = '".$personal_username."'";
