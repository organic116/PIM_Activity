...
<?php
    ...
    <td width='70px' bgcolor='#00aae1' align ='center'><B>จัดการข้อมูล</B></td>";
	...
	echo "<tr align='center'>";
     ...
     echo "<td>
			<a href='join_ar.php?ar_id=".$row["activities_id"]."'>
			 ...
			 <button type="submit" class="btn btn-danger"  name="submit" id="submit" onclick="return confirm('คุณต้องการลบกิจกรรใช่หรือไม่ ?')"
			 <?php echo $dis; ?>><i class="fas fa-trash-alt"></i>
			</button></a>
	 <?php 		"</td>";
      echo "</tr>";
    }
...
<nav aria-label="Page navigation example">
 <div class="clearfix">
  ...
  <ul class="pagination">
 &nbsp;&nbsp;&nbsp;&nbsp;<li class="page-item">
      <a class="page-link" href="admin_uishowar.php?page=1" aria-label="Previous">
        <span aria-hidden="true">&laquo;</span>
        <span class="sr-only">Previous</span>
      </a>
    </li>
	<?php for($i=1;$i<=$total_page;$i++){ ?>
    <li class="page-item"><a class="page-link" href="admin_uishowar.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
    <?php } ?>
    <li class="page-item">
      <a class="page-link" href="admin_uishowar.php?page=<?php echo $total_page;?>" aria-label="Next">
