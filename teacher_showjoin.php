...
$stu_id = $_GET["stu_id"];
	...
	$hour4 += $row4["activities_hour"];
			...
			$this->Ln();
			$this->Ln();
	 		$this->Cell(0,0,iconv( 'UTF-8','TIS-620','งานกิจกรรม คณะบริหารธุรกิจ '),0,1,"L");
...
$pdf->SetLeftMargin(5);
$pdf->Cell(0,7,iconv( 'UTF-8','cp874' ,'รหัสนักศึกษา :'.$rowar["user_id"].''),0,1,'L',$pdf->Cell(0,7,iconv( 'UTF-8','cp874' , 'ชื่อ-สกุล :'.$rowar["user_name"].'   '.$rowar["user_lastname"].'' ) , 0, 1,'C' ),$pdf->Cell(0,-7,iconv( 'UTF-8','cp874' ,'' ) , 0, 1,'R' ) );
