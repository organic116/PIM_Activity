...
<div class="form-group col-md-2.5">
 ...
 <div class="form-group col-md-2.5">
     <div class="input-group-prepend">
     <label for="name_month_joine">&nbsp;เดือนที่จัดกิจกรรม&nbsp;</label>
  </div>
...
<?php
    ...
    //2. query ข้อมูลจากตาราง :
    $query1 = "SELECT * FROM tb_activities  ORDER BY genus_id DESC,activities_addstart DESC ASC" or die(mysql_error());
    //3.เก็บข้อมูลที่ query ออกมาไว้ในตัวแปร result .
   ...
   echo "<tr align='center'>
	<td width='50px'  bgcolor='FFDAB9'><center><B>กลุ่มกิจกรรม</B></td>
	 <td width='100px'  bgcolor='FFDAB9'><center><B>ชื่อกิจกรรม</B></td>
	 <td  width='50px' bgcolor='FFDAB9'><center><B>วันจัดกิจกรรม</B></td>
	<td  width='100px' bgcolor='FFDAB9'><center><B>เวลาจัด - สิ้นสุดกิจกรรม</B></td>
	<td  width='40px' bgcolor='FFDAB9'><center><B>รายละเอียด</B></td></tr>";
     ...
     echo "<td   >" .'<center>'.DateThai ($row["activities_startdate"]).  "</td> ";
       echo "<td ><center>".date('H:i',strtotime($row["activities_starttime"]))."&nbsp;น. - ".date('H:i',strtotime($row["activities_endtime"]))."&nbsp;น.</td> ";
	echo "<td><center><a href='teacher_detailar.php?ar_id=$row[activities_id]'>
			  <button type='button' id='sidebarCollapse' class='btn btn-success'>
			<i class='fas fa-info-circle'></i></button></a></center></td> ";
     echo "</tr>";
 ...
 <div class="clearfix">
  ...
  <ul class="pagination">
 &nbsp;&nbsp;&nbsp;&nbsp;<li class="page-item">
      <a class="page-link" href="teacher_mainui.php?page=1" aria-label="Previous">
        <span aria-hidden="true">&laquo;</span>
        <span class="sr-only">Previous</span>
      </a>
    </li>
	<?php for($i=1;$i<=$total_page;$i++){ ?>
    <li class="page-item"><a class="page-link" href="teacher_mainui.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
    <?php } ?>
    <li class="page-item">
      <a class="page-link" href="teacher_mainui.php?page=<?php echo $total_page;?>" aria-label="Next">
