...
<br>
<a href="admin_showqrcode.php" ><input class="btn btn-outline-success my-2 my-sm-0" value="แสดง QRCODE"></a>
...
<?php } ?>
 ...
 <div class="clearfix">
                  ...
                  <ul class="pagination">
 <li>
 <a href="admin_showqrcode.php?page=1" aria-label="Previous">
 <span aria-hidden="true">&laquo;</span>
 </a>
 </li>
 <?php for($i=1;$i<=$total_page;$i++){ ?>
 <li  class="page-item"><a href="admin_showqrcode.php?page=<?php echo $i; ?>" class="page-link"><?php echo $i; ?></a></li>
 <?php } ?>
 <li >
 <a href="admin_showqrcode.php?page=<?php echo $total_page;?>" aria-label="Next">
